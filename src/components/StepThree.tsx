    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      <Alert severity="info" sx={{ mt: 2 }}>
        <Typography variant="body2">
          <strong>How it works:</strong> Our AI will analyze your input and
          generate a comprehensive Product Requirements Document including
          product overview, user stories, risk analysis, and MVP scope. All
          outputs are validated against a structured schema to ensure quality
          and consistency.
        </Typography>
      </Alert>
